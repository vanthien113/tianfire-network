...
/**
 * Created by vanthien113 on 3/21/18.
 */

public class CricleImage extends android.support.v7.widget.AppCompatImageView {
    ...
    public CricleImage(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.CircleImageView_borderColor)) {
            mCircleBackgroundColor = a.getColor(R.styleable.CircleImageView_borderColor,
